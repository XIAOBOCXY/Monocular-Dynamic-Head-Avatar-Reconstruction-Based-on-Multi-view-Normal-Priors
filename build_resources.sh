...
wget https://hf-mirror.com/xg-chu/GAGAvatar/resolve/main/assets/FLAME_with_eye.pt -O ./assets/FLAME_with_eye.pt
wget https://hf-mirror.com/xg-chu/GAGAvatar/resolve/main/assets/canonical.obj -O ./assets/canonical.obj
# wget https://huggingface.co/xg-chu/GAGAvatar/resolve/main/assets/GAGAvatar.pt -O ./assets/GAGAvatar.pt
wget https://hf-mirror.com/xg-chu/GAGAvatar/resolve/main/assets/GAGAvatar.pt -O ./assets/GAGAvatar.pt
